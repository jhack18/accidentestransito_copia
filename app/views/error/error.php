...
<head>
    ...
    <link rel="stylesheet" href="styles/error/css/style.css">
</head>
...
<div class="denied__wrapper">
    <h1>404</h1>
    <h3>¿Perdido en el <span>ESPACIO</span> sitio web? Hmm, parece que este sitio no existe o pero aún... ¡ROMPISTE EL SITIO WEB! :c</h3>
    ...
    <a href="index.php"><button class="denied__link">Vuelve al inicio</button></a>
</div>
<script src='https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js'></script>



<script  src="styles/error/js/index.js"></script>
