...
<div id="page-wrapper">
    <div class="row">
        <h1>Delito <small>Agregar Delito</small></h1>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-3">
            <input type="date" id="robo_fecha" style="width: 200px;">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-3">
            <textarea id="robo_descripcion" placeholder="Escriba su Descripcion" style="width: 200px;" cols="4"></textarea>
        </div>
    </div>

    <div class="row form-group">
        <div class="col-lg-2">
            <label>Arma del Delito</label>
        </div>
        <div class="col-lg-3">
            <select id="robo_arma" style="width: 200px;">
                <?php
                foreach ($armas as $arma){
                    ?><option value="<?php echo $arma->arma_id;?>"><?php echo $arma->arma_nombre; ?></option>
                    <?php
                }
                ?>
            </select>
        ...
        <div class="col-lg-3">
            <select id="robo_delito" style="width: 200px;">
                ...
                foreach ($delitos as $delito){
                    ?><option value="<?php echo $delito->delito_id;?>"><?php echo $delito->delito_nombre; ?></option>
                    <?php
                }
                ?>
            </select>
    ...
    <div class="row form-group">
        <div class="col-lg-2">
            <button class="btn btn-success" onclick="agregar()">Agregar Robo</button>
        </div>
    </div>
