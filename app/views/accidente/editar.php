...
<script type="text/javascript">
    ...
    window.onload = function () {
        var latLng = new google.maps.LatLng(<?php echo $accidente->calle_x;?>,<?php echo $accidente->calle_y;?>);
        var opciones = {
            center: latLng,
            zoom: 15,
        };
...
<div id="page-wrapper">
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-3">
            <select id="accidente_causaaccidente" style="width: 200px;">
                <?php
                $accident = $accidente->causa;
                ?>
                <?php
                foreach ($causaaccidentes as $causa){
                    ?><option <?php echo $accident == $causa->causaaccidente_id ? 'selected' : '';?> value="<?php echo $causa->causaaccidente_id;?>"><?php echo $causa->causaaccidente_nombre; ?></option>
                    <?php
                }
                ?>
            </select>
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-3">
            <input type="date" id="accidente_fecha" value="<?php echo $accidente->fecha;?>" style="width: 200px;">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-3">
            <select id="accidente_fatal" style="width: 200px;">
                <?php
                $habil = $accidente->fatal;
                ?>
                <option <?php echo $habil == "NO" ? 'selected' : '';?> value="NO">NO</option>
                <option <?php echo $habil == "SI" ? 'selected' : '';?> value="SI">SI</option>
            </select>
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-3">
            <textarea id="accidente_descripcion" placeholder="Escriba su Descripcion" style="width: 200px;" cols="4"><?php echo $accidente->descripcion;?></textarea>
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-3">
            <input type="text" id="calle_nombre" placeholder="Escriba su Calle" value="<?php echo $accidente->nombre?>" style="width: 200px;">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-3">
            <input type="text" id="calle_x" placeholder="Ingresar" value="<?php echo $accidente->calle_x;?>" style="width: 200px;">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-lg-2">
        ...
        <div class="col-lg-3">
            <input type="text" id="calle_y" placeholder="Ingresar" value="<?php echo $accidente->calle_y;?>" style="width: 200px;">
        </div>
    </div>
    <div class="row form-group">
        <div>
    ...
    <div class="row form-group">
        <div class="col-lg-2">
            <button class="btn btn-success" onclick="agregar()">Editar Accidente</button>
        </div>
    </div>
