...
<div id="page-wrapper">
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-3">
            <input type="text" id="usuario_nombre" placeholder="Escriba su Nombre" value="<?php echo $usuario->nombre;?>">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-lg-2">
        ...
        <div class="col-lg-3">
            <input type="text" id="usuario_apellido" placeholder="Escriba su Apellido" value="<?php echo $usuario->apellido;?>">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-lg-2">
        ...
        <div class="col-lg-3">
            <input type="text" id="usuario_dni" maxlength="8" placeholder="Escriba su DNI" value="<?php echo $usuario->dni;?>">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-lg-2">
        ...
        <div class="col-lg-3">
            <input type="text" id="usuario_nickname" placeholder="Escriba su Nickname" value="<?php echo $usuario->nickname;?>">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-lg-2">
        ...
        <div class="col-lg-3">
            <input type="password" id="usuario_contrasenha" placeholder="Escriba su Contraseña" value="<?php echo $usuario->contrasenha;?>">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-lg-2">
        ...
        <div class="col-lg-3">
            <input type="password" id="usuario_contrasenha2" placeholder="Escriba su Contraseña" value="<?php echo $usuario->contrasenha;?>">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-lg-2">
